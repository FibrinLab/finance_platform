    ...
    >
      <PerfectScrollbar className="deznav-scroll">
        ...
        <MM className="metismenu" id="menu">
          ...
          <li>
            <Link className={`${path === "app-profile" ? "mm-active" : ""}`} to="/app-profile" >
              <i className="flaticon-077-menu-1"></i>
              <span className="nav-text">Profile</span>
            </Link>
          </li>
          <li>
            <Link className={`${path === "app-calender" ? "mm-active" : ""}`}to="/app-calender" >
              <i className="flaticon-061-puzzle"></i>
              <span className="nav-text">Wallet</span>
            </Link>
          </li>
          <li>
            <Link className={`${path === "post-details" ? "mm-active" : ""}`} to="/post-details" >
              <i className="flaticon-077-menu-1"></i>
              <span className="nav-text">Message Board</span>
            </Link>
          </li>
            {/* <ul >
		...
		<div className="copyright">
			<p><strong>Web3Encore</strong> © 2022 All Rights Reserved</p>
